...
public class FFmpegUtil {
    ...
    public static String[] mediaMux(String videoFile, String audioFile, int duration, String muxFile) {
        ...
        String mixAudioCmd = "-i %s -i %s -t %d %s";
...
//        String transformVideoCmd = "-i %s -r 25 -b 200 -s 1080x720 %s";
    ...
    public static String[] screenRecord(String size, int recordTime, String targetFile) {
        ...
        String screenRecordCmd = "-vcodec mpeg4 -b 1000 -r 10 -g 300 -vd x11:0,0 -s %s -t %d %s";
    ...
    public static String[] pictureToVideo(String srcFile, String targetFile) {
        ...
        String combineVideo = "-f image2 -r 1 -i %simg#d.jpg -vcodec mpeg4 %s";
...
//        String reverseVideo = "-i %s -filter_complex [0:v]reverse[v];[0:a]areverse[a] -map [v] -map [a] %s";
    ...
    public static String[] picInPicVideo(String inputFile1, String inputFile2, int x, int y, String targetFile) {
        String reverseVideo = "-i %s -i %s -filter_complex overlay=%d:%d %s";
